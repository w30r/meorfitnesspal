...
const CalorieTrendChart = dynamic(
  () => import("@/components/charts/CalorieTrendChart"),
  {
    ssr: false,
    loading: () => (
...
const MacroDonutChart = dynamic(
  () => import("@/components/charts/MacroDonutChart"),
  {
    ssr: false,
...
export default function Home() {
  ...
  const hasMacros =
    foodLog &&
    (foodLog.totalProtein > 0 ||
      foodLog.totalCarbs > 0 ||
      foodLog.totalFats > 0);
                    ...
                    <div className="bg-card border border-border rounded-[2.5rem] p-4 shadow-sm aspect-square animate-in fade-in slide-in-from-bottom-1 duration-500 flex flex-col justify-between">
                      ...
                      <div className="flex items-baseline gap-1">
                        <span className="text-4xl font-black tabular-nums">
                          <AnimatedNumber value={weeklyWeightAvg} decimals={1} />
                        </span>
                  ...
                  <div className="flex-shrink-0 w-44 animate-in fade-in slide-in-from-bottom-1 duration-500 delay-[25ms]">
                    <div className="bg-card border border-border rounded-[2.5rem] p-4 shadow-sm aspect-square flex flex-col justify-between">
                      ...
                      <p className="text-4xl font-black tabular-nums">
                        <AnimatedNumber value={steps} locale />
                      </p>
                    </div>
                  </div>
                ) : null}
                ...
                {activeEnergy || restingEnergy ? (
                  <div className="flex-shrink-0 w-44 animate-in fade-in slide-in-from-bottom-1 duration-500 delay-[50ms]">
                    <div className="bg-card border border-border rounded-[2.5rem] p-4 shadow-sm aspect-square flex flex-col justify-between">
                      ...
                      <div className="flex items-baseline gap-1">
                        <span className="text-4xl font-black tabular-nums">
                          <AnimatedNumber value={(activeEnergy || 0) + (restingEnergy || 0)} />
                        </span>
                        <span className="text-sm font-medium text-muted-foreground">
                          kcal
                        </span>
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-5xl font-black tracking-tighter text-foreground">
                      <AnimatedNumber value={foodLog?.totalCalories || 0} />
                    </span>
                    <span className="text-xl font-medium text-muted-foreground italic">
                      / <AnimatedNumber value={goal?.calories || 0} />
                    </span>
                  </div>
                  ...
                  <div className="w-full mt-4 space-y-2">
                    <div className="flex justify-between text-xs font-bold px-1">
                      <span className="text-primary">
                        <AnimatedNumber value={caloriePercentage} />% of daily goal
                      </span>
              ...
              <section className="md:col-span-2 lg:col-span-3 animate-in fade-in slide-in-from-bottom-2 duration-500 delay-250">
                {achievements.length > 0 ? (
                  ...
                  <div className="bg-card border border-dashed border-border/50 rounded-[2.5rem] p-4 shadow-sm flex flex-col items-center justify-center gap-2 text-muted-foreground py-6">
                    ...
                    <span className="text-xs font-medium">
                      Log meals and build streaks to earn achievements!
                    </span>
                  </div>
                )}
              </section>
